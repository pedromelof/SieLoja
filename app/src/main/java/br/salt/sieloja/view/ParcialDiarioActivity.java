...
import br.salt.sieloja.databinding.ActivityParcialDiarioBinding;
...
public class ParcialDiarioActivity extends BaseActivity {

    Date dataInicio;
    Date dataFim;
    private ActivityParcialDiarioBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityParcialDiarioBinding.inflate(getLayoutInflater());
    ...
    public void afterView() {
        try {
            ...
            DecimalFormat dfQtd = new DecimalFormat("#0");
            String valorFormatado = df.format(bruto);
            String qtdTotalFormatado = dfQtd.format(parcialController.getTotalItens());
...
//            binding.textValorTotalItens.setText(String.valueOf((int) parcialController.getTotalItens()));
            ...
            binding.valQtdTotal.setText(qtdTotalFormatado);
            binding.valValorTotal.setText(valorFormatado);
...
//			totalHeight += 38;
    ...
    public void imprimirParcial() {
        new Thread(() -> {
            ...
            try {
                parcialController.restParcialDiariaImpre(dataInicio, dataFim);
